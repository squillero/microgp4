...
def hierarchical_mutation(original_individual: Individual, strength: float, **kwargs) -> List[Optional[Individual]]:
    ...
    while True:
        ...
        while True:
            ...
            chosen_node = randy.choice(new_individual.nodes())
            ...
            if candidate_parameters:
                ...
                chosen_parameter = randy.choice(candidate_parameters)
                assert strength
        ...
        # Stop condition
        # TODO: HORRIBLE!!!!!!!!!!!
        if strength == 1.0 or randy.boolean(p_false=strength):
            break
...
def flat_mutation(original_individual: Individual, strength: float, **kwargs) -> List[Optional[Individual]]:
    ...
    while True:
        ...
        # Stop condition
        # TODO: HORRIBLE!!!!
        if strength == 1.0 or not (randy.random() < strength):
            break
