...
if __name__ == "__main__":
    ...
    if args.verbose == 0:
        ugp4.utils.logging.DefaultLogger.setLevel(level=ugp4.utils.logging.INFO)
    elif args.verbose == 1:
        ugp4.utils.logging.DefaultLogger.setLevel(level=ugp4.utils.logging.VERBOSE)
    elif args.verbose > 1:
        ugp4.utils.logging.DefaultLogger.setLevel(level=ugp4.utils.logging.DEBUG)
        ugp4.utils.logging.debug("Verbose level set to DEBUG")

    ugp4.utils.logging.log_cpu(ugp4.utils.logging.INFO, "Program started")
    ...
    # That's all
    ugp4.utils.logging.bare("Final archive:")
    for i in darwin.archive.individuals:
        ugp4.utils.logging.bare(f"{i.id}: {i} [{i.fitness}]")

    ugp4.utils.logging.log_cpu(ugp4.utils.logging.INFO, "Program completed")
    sys.exit(0)
