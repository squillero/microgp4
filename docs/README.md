...
The latest version is available as a [PyPi package](https://pypi.org/project/microgp/); the documentation is hosted on [ReadTheDocs](https://microgp4.readthedocs.io/).
