...
MicroGP [history](history.html) started around 2000 with the creation of a prototype able to optimize realistic assembly language, a fully working version was coded in C in 2002 and then re-engineered in C++ in 2006. The forth version has been redesigned from scratch in Python.
