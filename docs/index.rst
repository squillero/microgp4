...
The first prototype was created `around Y2K <HISTORY.md>`__; the first fully working version, was `coded in C in 2002 </MicroGP2/MicroGP2>`_ and then `re-engineered in C++ in 2006 </MicroGP3>`_. This fourth version has been redesigned from scratch. MicroGP would not have been possible without the help and support of `several people <CONTRIBUTORS.md>`__.
