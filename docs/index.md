...
The [history](history.html) of MicroGP started around 2000 with the creation of a script able to optimize realistic assembly language, a fully working version was coded in C in 2002 and then re-engineered in C++ in 2006. The forth version has been redesigned from scratch in Python in 2019.
